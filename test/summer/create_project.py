...
cli_provider = os.getenv("CLI_PROVIDER", "claude-cli")

print(f"EXECUTION_MODE: {execution_mode}")
if execution_mode.lower() == "api":
    print(f"API_PROVIDER: {api_provider}")
elif execution_mode.lower() == "cli":
    print(f"CLI_PROVIDER: {cli_provider}")
print()

logging.info(f"EXECUTION_MODE: {execution_mode}")
logging.info(f"API_PROVIDER: {api_provider}")
logging.info(f"CLI_PROVIDER: {cli_provider}")
